...
(10, 3, 1000.00, '2025-08-17 09:19:35', '2025-08-17 13:25:39');
...
(11, 10, 1, 66, 1, '2025-08-17 13:25:39', NULL);
...
(66, 1, 2, 6, 'WH-MEDIUM-WHITE', 1000.00, 'EGP', 30, '2025-03-26 08:16:32', NULL),
...
(1, 9223372036854775807, 'uploads/profile_pictures/33864171114794816dbc188b7f979d29.jpg', 'OMar', 'Khaled', 'ok3050802@gmail.com', '$2y$10$tmtTdfjLzJmRONB.clzRled515/.chl8cjjRMNEhiNASsgUjJaHHC', '2000-12-11', '01286246292', '2025-08-15 17:08:57', NULL, 'male', 'active', 'admin', 0),
...
(3, NULL, 'uploads/it.helpdesk@hungerstationbfc.com/avatar.png', 'it', 'helpdesk', 'it.helpdesk@hungerstationbfc.com', '$2y$10$ctXUzmWVtN6I.tpxUpYu.eIFI9ej2URXEd.cW3Hog8rZm4cEEmaBC', '2000-12-12', '01222222222', '2025-08-17 09:19:35', NULL, 'male', 'deactivated', 'user', 0);
...
ALTER TABLE `password_resets`
  ...
  ADD KEY `idx_password_resets_token_valid` (`token`,`expires_at`,`used`);
